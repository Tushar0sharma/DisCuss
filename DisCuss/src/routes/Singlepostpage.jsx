...
const Singlepostpage = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-20 min-h-screen bg-black text-white">
      <Particles 
      ...
      <div className="flex flex-col lg:flex-row gap-6">
        ...
        <div className="lg:w-2/3">
          ...
          <div className="flex items-center space-x-4 mb-6">
            ...
            />
            <div>
              <h2 className="text-xl font-semibold">{blog.author?.name || "Unknown Author"}</h2>
              {blog.author?.bio && (
          ...
          <div className="border-t border-gray-600 mt-8 pt-6">
            ...
            <Commentlist blogid={blog._id} newcomment={newComment} />
          </div>
        </div>

        {/* Right Column: Related Posts Sidebar */}
        <div className="lg:w-1/3">
          <div style={{backgroundColor:"#212121"}} className="sticky top-20 p-6  rounded-lg shadow-lg border border-gray-600">
            <h2 className="text-2xl font-bold mb-6 border-b pb-2">Related Blogs</h2>
            {(() => {
              const filteredPosts = relatedPosts.filter((post) => post.slug !== slug);
              if (filteredPosts.length === 0) {
                return <p className="text-gray-400 text-sm">No related Blogs found.</p>;
              }
